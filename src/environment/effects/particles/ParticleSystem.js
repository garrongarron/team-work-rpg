...
import { TextureLoader, ShaderMaterial, BufferGeometry, Float32BufferAttribute, Points, Color, Vector3 } from 'three'
class ParticleSystem {
    constructor(params) {
        ...
        const uniforms = {
            diffuseTexture: {
                value: new TextureLoader().load('src/environment/effects/particles/' + this._params.texture + '.png')
            },
            pointMultiplier: {
